...
describe("M1 parity regression guard", () => {
  ...
  test("critical endpoint schema checks stay covered", () => {
    ...
    expect(output).toContain(
      "PASS: notification-service MessagingFaultManifestVerifyAttemptAnomalyEscalationState pendingSince schema property contract"
    );
    expect(output).toContain(
      "PASS: notification-service MessagingFaultManifestVerifyAttemptAnomalyEscalationState escalatedAt schema property contract"
    );
    expect(output).toContain(
      "PASS: notification-service MessagingFaultManifestVerifyAttemptAnomalyEscalationState resolvedAt schema property contract"
    );
    expect(output).toContain(
      "PASS: notification-service MessagingFaultManifestVerifyAttemptAnomalyEscalationState dueAt schema property contract"
    );
    expect(output).toContain(
      "PASS: notification-service MessagingFaultManifestVerifyAttemptAnomalyEscalationState actionRequired schema property contract"
    );
    expect(output).toContain(
      "PASS: notification-service MessagingFaultManifestVerifyAttemptAnomalyEscalationState acknowledgementSla schema property contract"
    );
    expect(output).toContain(
      "PASS: notification-service MessagingFaultManifestVerifyAttemptAnomalyEscalationAcknowledgementSla targetSeconds schema property contract"
    );
    expect(output).toContain(
      "PASS: notification-service MessagingFaultManifestVerifyAttemptAnomalyEscalationAcknowledgementSla elapsedSeconds schema property contract"
    );
    expect(output).toContain(
      "PASS: notification-service MessagingFaultManifestVerifyAttemptAnomalyEscalationAcknowledgementSla remainingSeconds schema property contract"
    );
    expect(output).toContain(
      "PASS: notification-service MessagingFaultManifestVerifyAttemptAnomalyEscalationAcknowledgementSla breachSeconds schema property contract"
    );
    expect(output).toContain(
      "PASS: notification-service MessagingFaultManifestVerifyAttemptAnomalyEscalationAcknowledgementSla measuredFrom schema property contract"
    );
    expect(output).toContain(
      "PASS: notification-service MessagingFaultManifestVerifyAttemptAnomalyEscalationAcknowledgementSla measuredUntil schema property contract"
    );
    expect(output).toContain(
      "PASS: notification-service MessagingFaultManifestVerifyAttemptAnomalyEscalationAcknowledgementSla acknowledgedAt schema property contract"
    );
    expect(output).toContain(
      "PASS: notification-service MessagingFaultManifestVerifyAttemptEscalationPolicy mitigationNoteTypes schema property contract"
    );
    expect(output).toContain(
    ...
    expect(output).toContain(
      "PASS: notification-service MessagingFaultManifestVerifyAttemptRetentionSaturationTrendSnapshot alertLevel schema property contract"
    );
    expect(output).toContain(
      "PASS: notification-service MessagingFaultManifestVerifyAttemptRetentionSaturation currentEntries schema property contract"
    );
    expect(output).toContain(
      "PASS: notification-service MessagingFaultManifestVerifyAttemptRetentionSaturation maxEntries schema property contract"
    );
    expect(output).toContain(
      "PASS: notification-service MessagingFaultManifestVerifyAttemptRetentionSaturation utilizationPercent schema property contract"
    );
    expect(output).toContain(
      "PASS: notification-service MessagingFaultManifestVerifyAttemptRetentionSaturation remainingEntries schema property contract"
    );
    expect(output).toContain(
  ...
  test("fails strict check when anomaly escalation state pendingSince type drifts", () => {
    withMutatedNotificationSpec(
      (source) =>
        replaceOneOrThrow(
          source,
          /(MessagingFaultManifestVerifyAttemptAnomalyEscalationState:[\s\S]*?pendingSince:[\s\S]*?type:\s*)string/,
          "$1integer",
          "anomaly escalation state pendingSince type"
        ),
      (result, output) => {
        expect(result.status).toBe(1);
        expect(output).toContain("Parameter contract failures");
        expect(output).toContain(
          "notification-service MessagingFaultManifestVerifyAttemptAnomalyEscalationState pendingSince schema property contract"
        );
        expect(output).toContain(
          "schema property MessagingFaultManifestVerifyAttemptAnomalyEscalationState.pendingSince type expected string got integer"
        );
      }
    );
  });

  test("fails strict check when anomaly escalation state escalatedAt type drifts", () => {
    withMutatedNotificationSpec(
      (source) =>
        replaceOneOrThrow(
          source,
          /(MessagingFaultManifestVerifyAttemptAnomalyEscalationState:[\s\S]*?escalatedAt:[\s\S]*?type:\s*)string/,
          "$1boolean",
          "anomaly escalation state escalatedAt type"
        ),
      (result, output) => {
        expect(result.status).toBe(1);
        expect(output).toContain("Parameter contract failures");
        expect(output).toContain(
          "notification-service MessagingFaultManifestVerifyAttemptAnomalyEscalationState escalatedAt schema property contract"
        );
        expect(output).toContain(
          "schema property MessagingFaultManifestVerifyAttemptAnomalyEscalationState.escalatedAt type expected string got boolean"
        );
      }
    );
  });

  test("fails strict check when anomaly escalation state resolvedAt type drifts", () => {
    withMutatedNotificationSpec(
      (source) =>
        replaceOneOrThrow(
          source,
          /(MessagingFaultManifestVerifyAttemptAnomalyEscalationState:[\s\S]*?resolvedAt:[\s\S]*?type:\s*)string/,
          "$1number",
          "anomaly escalation state resolvedAt type"
        ),
      (result, output) => {
        expect(result.status).toBe(1);
        expect(output).toContain("Parameter contract failures");
        expect(output).toContain(
          "notification-service MessagingFaultManifestVerifyAttemptAnomalyEscalationState resolvedAt schema property contract"
        );
        expect(output).toContain(
          "schema property MessagingFaultManifestVerifyAttemptAnomalyEscalationState.resolvedAt type expected string got number"
        );
      }
    );
  });

  test("fails strict check when anomaly escalation state dueAt type drifts", () => {
    withMutatedNotificationSpec(
      (source) =>
        replaceOneOrThrow(
          source,
          /(MessagingFaultManifestVerifyAttemptAnomalyEscalationState:[\s\S]*?dueAt:[\s\S]*?type:\s*)string/,
          "$1integer",
          "anomaly escalation state dueAt type"
        ),
      (result, output) => {
        expect(result.status).toBe(1);
        expect(output).toContain("Parameter contract failures");
        expect(output).toContain(
          "notification-service MessagingFaultManifestVerifyAttemptAnomalyEscalationState dueAt schema property contract"
        );
        expect(output).toContain(
          "schema property MessagingFaultManifestVerifyAttemptAnomalyEscalationState.dueAt type expected string got integer"
        );
      }
    );
  });

  test("fails strict check when anomaly escalation state actionRequired type drifts", () => {
    withMutatedNotificationSpec(
      (source) =>
        replaceOneOrThrow(
          source,
          /(MessagingFaultManifestVerifyAttemptAnomalyEscalationState:[\s\S]*?actionRequired:[\s\S]*?type:\s*)boolean/,
          "$1string",
          "anomaly escalation state actionRequired type"
        ),
      (result, output) => {
        expect(result.status).toBe(1);
        expect(output).toContain("Parameter contract failures");
        expect(output).toContain(
          "notification-service MessagingFaultManifestVerifyAttemptAnomalyEscalationState actionRequired schema property contract"
        );
        expect(output).toContain(
          "schema property MessagingFaultManifestVerifyAttemptAnomalyEscalationState.actionRequired type expected boolean got string"
        );
      }
    );
  });

  test("fails strict check when anomaly escalation state acknowledgementSla property is removed", () => {
    withMutatedNotificationSpec(
      (source) =>
        replaceOneOrThrow(
          source,
          /(MessagingFaultManifestVerifyAttemptAnomalyEscalationState:[\s\S]*?)\n\s{8}acknowledgementSla:\n\s{10}\$ref:\s*"#\/components\/schemas\/MessagingFaultManifestVerifyAttemptAnomalyEscalationAcknowledgementSla"/,
          "$1",
          "anomaly escalation state acknowledgementSla property"
        ),
      (result, output) => {
        expect(result.status).toBe(1);
        expect(output).toContain("Parameter contract failures");
        ...
        expect(output).toContain(
          "missing schema property MessagingFaultManifestVerifyAttemptAnomalyEscalationState.acknowledgementSla"
        );
      }
    );
  });

  test("fails strict check when anomaly escalation acknowledgement SLA targetSeconds type drifts", () => {
    withMutatedNotificationSpec(
      (source) =>
        replaceOneOrThrow(
          source,
          /(MessagingFaultManifestVerifyAttemptAnomalyEscalationAcknowledgementSla:[\s\S]*?targetSeconds:[\s\S]*?type:\s*)integer/,
          "$1boolean",
          "anomaly escalation acknowledgement SLA targetSeconds type"
        ),
      (result, output) => {
        expect(result.status).toBe(1);
        expect(output).toContain("Parameter contract failures");
        ...
        expect(output).toContain(
          "schema property MessagingFaultManifestVerifyAttemptAnomalyEscalationAcknowledgementSla.targetSeconds type expected integer got boolean"
        );
      }
    );
  });

  test("fails strict check when anomaly escalation acknowledgement SLA elapsedSeconds type drifts", () => {
    withMutatedNotificationSpec(
      (source) =>
        replaceOneOrThrow(
          source,
          /(MessagingFaultManifestVerifyAttemptAnomalyEscalationAcknowledgementSla:[\s\S]*?elapsedSeconds:[\s\S]*?type:\s*)integer/,
          "$1string",
          "anomaly escalation acknowledgement SLA elapsedSeconds type"
        ),
      (result, output) => {
        expect(result.status).toBe(1);
        expect(output).toContain("Parameter contract failures");
        expect(output).toContain(
          "notification-service MessagingFaultManifestVerifyAttemptAnomalyEscalationAcknowledgementSla elapsedSeconds schema property contract"
        );
        expect(output).toContain(
          "schema property MessagingFaultManifestVerifyAttemptAnomalyEscalationAcknowledgementSla.elapsedSeconds type expected integer got string"
        );
      }
    );
  });

  test("fails strict check when anomaly escalation acknowledgement SLA remainingSeconds type drifts", () => {
    withMutatedNotificationSpec(
      (source) =>
        replaceOneOrThrow(
          source,
          /(MessagingFaultManifestVerifyAttemptAnomalyEscalationAcknowledgementSla:[\s\S]*?remainingSeconds:[\s\S]*?type:\s*)integer/,
          "$1number",
          "anomaly escalation acknowledgement SLA remainingSeconds type"
        ),
      (result, output) => {
        expect(result.status).toBe(1);
        expect(output).toContain("Parameter contract failures");
        expect(output).toContain(
          "notification-service MessagingFaultManifestVerifyAttemptAnomalyEscalationAcknowledgementSla remainingSeconds schema property contract"
        );
        expect(output).toContain(
          "schema property MessagingFaultManifestVerifyAttemptAnomalyEscalationAcknowledgementSla.remainingSeconds type expected integer got number"
        );
      }
    );
  });

  test("fails strict check when anomaly escalation acknowledgement SLA breachSeconds type drifts", () => {
    withMutatedNotificationSpec(
      (source) =>
        replaceOneOrThrow(
          source,
          /(MessagingFaultManifestVerifyAttemptAnomalyEscalationAcknowledgementSla:[\s\S]*?breachSeconds:[\s\S]*?type:\s*)integer/,
          "$1boolean",
          "anomaly escalation acknowledgement SLA breachSeconds type"
        ),
      (result, output) => {
        expect(result.status).toBe(1);
        expect(output).toContain("Parameter contract failures");
        expect(output).toContain(
          "notification-service MessagingFaultManifestVerifyAttemptAnomalyEscalationAcknowledgementSla breachSeconds schema property contract"
        );
        expect(output).toContain(
          "schema property MessagingFaultManifestVerifyAttemptAnomalyEscalationAcknowledgementSla.breachSeconds type expected integer got boolean"
        );
      }
    );
  });

  test("fails strict check when anomaly escalation acknowledgement SLA measuredFrom type drifts", () => {
    withMutatedNotificationSpec(
      (source) =>
        replaceOneOrThrow(
          source,
          /(MessagingFaultManifestVerifyAttemptAnomalyEscalationAcknowledgementSla:[\s\S]*?measuredFrom:[\s\S]*?type:\s*)string/,
          "$1integer",
          "anomaly escalation acknowledgement SLA measuredFrom type"
        ),
      (result, output) => {
        expect(result.status).toBe(1);
        expect(output).toContain("Parameter contract failures");
        expect(output).toContain(
          "notification-service MessagingFaultManifestVerifyAttemptAnomalyEscalationAcknowledgementSla measuredFrom schema property contract"
        );
        expect(output).toContain(
          "schema property MessagingFaultManifestVerifyAttemptAnomalyEscalationAcknowledgementSla.measuredFrom type expected string got integer"
        );
      }
    );
  });

  test("fails strict check when anomaly escalation acknowledgement SLA measuredUntil type drifts", () => {
    withMutatedNotificationSpec(
      (source) =>
        replaceOneOrThrow(
          source,
          /(MessagingFaultManifestVerifyAttemptAnomalyEscalationAcknowledgementSla:[\s\S]*?measuredUntil:[\s\S]*?type:\s*)string/,
          "$1boolean",
          "anomaly escalation acknowledgement SLA measuredUntil type"
        ),
      (result, output) => {
        expect(result.status).toBe(1);
        expect(output).toContain("Parameter contract failures");
        ...
        expect(output).toContain(
          "schema property MessagingFaultManifestVerifyAttemptAnomalyEscalationAcknowledgementSla.measuredUntil type expected string got boolean"
        );
      }
    );
  });

  test("fails strict check when anomaly escalation acknowledgement SLA acknowledgedAt type drifts", () => {
    withMutatedNotificationSpec(
      (source) =>
        replaceOneOrThrow(
          source,
          /(MessagingFaultManifestVerifyAttemptAnomalyEscalationAcknowledgementSla:[\s\S]*?acknowledgedAt:[\s\S]*?type:\s*)string/,
          "$1integer",
          "anomaly escalation acknowledgement SLA acknowledgedAt type"
        ),
      (result, output) => {
        expect(result.status).toBe(1);
        expect(output).toContain("Parameter contract failures");
        ...
        expect(output).toContain(
          "schema property MessagingFaultManifestVerifyAttemptAnomalyEscalationAcknowledgementSla.acknowledgedAt type expected string got integer"
        );
      }
    );
  });

  test("fails strict check when escalation policy mitigationNoteTypes type drifts", () => {
    withMutatedNotificationSpec(
      (source) =>
        replaceOneOrThrow(
          source,
          /(MessagingFaultManifestVerifyAttemptEscalationPolicy:[\s\S]*?mitigationNoteTypes:[\s\S]*?type:\s*)array/,
          "$1object",
          "escalation policy mitigationNoteTypes type"
        ),
      (result, output) => {
        expect(result.status).toBe(1);
        expect(output).toContain("Parameter contract failures");
        ...
        expect(output).toContain(
          "schema property MessagingFaultManifestVerifyAttemptEscalationPolicy.mitigationNoteTypes type expected array got object"
        );
      }
    );
  });

  test("fails strict check when retention saturation trend snapshot capturedAt type drifts", () => {
    withMutatedNotificationSpec(
      (source) =>
        replaceOneOrThrow(
          source,
          /(MessagingFaultManifestVerifyAttemptRetentionSaturationTrendSnapshot:[\s\S]*?capturedAt:[\s\S]*?type:\s*)string/,
          "$1number",
          "retention saturation trend snapshot capturedAt type"
        ),
      (result, output) => {
        expect(result.status).toBe(1);
        expect(output).toContain("Parameter contract failures");
  ...
  test("fails strict check when retention saturation trend snapshot alertLevel type drifts", () => {
    withMutatedNotificationSpec(
      (source) =>
        replaceOneOrThrow(
          source,
          /(MessagingFaultManifestVerifyAttemptRetentionSaturationTrendSnapshot:[\s\S]*?alertLevel:[\s\S]*?type:\s*)string/,
          "$1integer",
          "retention saturation trend snapshot alertLevel type"
        ),
      (result, output) => {
        expect(result.status).toBe(1);
        expect(output).toContain("Parameter contract failures");
        expect(output).toContain(
          "notification-service MessagingFaultManifestVerifyAttemptRetentionSaturationTrendSnapshot alertLevel schema property contract"
        );
        expect(output).toContain(
          "schema property MessagingFaultManifestVerifyAttemptRetentionSaturationTrendSnapshot.alertLevel type expected string got integer"
        );
      }
    );
  });

  test("fails strict check when retention saturation currentEntries type drifts", () => {
    withMutatedNotificationSpec(
      (source) =>
        replaceOneOrThrow(
          source,
          /(MessagingFaultManifestVerifyAttemptRetentionSaturation:[\s\S]*?currentEntries:[\s\S]*?type:\s*)integer/,
          "$1string",
          "retention saturation currentEntries type"
        ),
      (result, output) => {
        expect(result.status).toBe(1);
        expect(output).toContain("Parameter contract failures");
        expect(output).toContain(
          "notification-service MessagingFaultManifestVerifyAttemptRetentionSaturation currentEntries schema property contract"
        );
        expect(output).toContain(
          "schema property MessagingFaultManifestVerifyAttemptRetentionSaturation.currentEntries type expected integer got string"
        );
      }
    );
  });

  test("fails strict check when retention saturation maxEntries type drifts", () => {
    withMutatedNotificationSpec(
      (source) =>
        replaceOneOrThrow(
          source,
          /(MessagingFaultManifestVerifyAttemptRetentionSaturation:[\s\S]*?maxEntries:[\s\S]*?type:\s*)integer/,
          "$1boolean",
          "retention saturation maxEntries type"
        ),
      (result, output) => {
        expect(result.status).toBe(1);
        expect(output).toContain("Parameter contract failures");
        expect(output).toContain(
          "notification-service MessagingFaultManifestVerifyAttemptRetentionSaturation maxEntries schema property contract"
        );
        expect(output).toContain(
          "schema property MessagingFaultManifestVerifyAttemptRetentionSaturation.maxEntries type expected integer got boolean"
        );
      }
    );
  });

  test("fails strict check when retention saturation utilizationPercent type drifts", () => {
    withMutatedNotificationSpec(
      (source) =>
        replaceOneOrThrow(
          source,
          /(MessagingFaultManifestVerifyAttemptRetentionSaturation:[\s\S]*?utilizationPercent:[\s\S]*?type:\s*)number/,
          "$1integer",
          "retention saturation utilizationPercent type"
        ),
      (result, output) => {
        expect(result.status).toBe(1);
        expect(output).toContain("Parameter contract failures");
        expect(output).toContain(
          "notification-service MessagingFaultManifestVerifyAttemptRetentionSaturation utilizationPercent schema property contract"
        );
        expect(output).toContain(
          "schema property MessagingFaultManifestVerifyAttemptRetentionSaturation.utilizationPercent type expected number got integer"
        );
      }
    );
  });

  test("fails strict check when retention saturation remainingEntries type drifts", () => {
    withMutatedNotificationSpec(
      (source) =>
        replaceOneOrThrow(
          source,
          /(MessagingFaultManifestVerifyAttemptRetentionSaturation:[\s\S]*?remainingEntries:[\s\S]*?type:\s*)integer/,
          "$1string",
          "retention saturation remainingEntries type"
        ),
      (result, output) => {
        expect(result.status).toBe(1);
        expect(output).toContain("Parameter contract failures");
        expect(output).toContain(
          "notification-service MessagingFaultManifestVerifyAttemptRetentionSaturation remainingEntries schema property contract"
        );
        expect(output).toContain(
          "schema property MessagingFaultManifestVerifyAttemptRetentionSaturation.remainingEntries type expected integer got string"
        );
      }
    );
  });

...
| GET    | `/integrations/messaging/fault-injection/manifest/verify/attempts/retention`                  | Show retention policy plus saturation/trend anomaly flags with severity and operator guidance for sustained-risk review.   |
| GET    | `/integrations/messaging/fault-injection/manifest/verify/attempts/retention/saturation-trend` | Query saturation trend snapshots with anomaly keys/severity using time-window and limit controls for operational triage.   |

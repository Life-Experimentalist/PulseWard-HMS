...
| POST   | `/integrations/messaging/fault-injection/manifest/verify` | Verify digest/signature plus replay-defense checks (issuedAt freshness and optional nonce correlation). |

...
| GET    | `/integrations/messaging/fault-injection/manifest/verify/attempts/retention`       | Show replay-attempt retention policy, saturation alert level, trend snapshots, and recommended operator action.            |
| GET    | `/integrations/messaging/fault-injection/manifest/verify/attempts/retention/saturation-trend` | Query replay-attempt saturation trend snapshots with time-window and limit controls for operational review.        |

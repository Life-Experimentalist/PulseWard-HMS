...
import { LayoutDashboard, Users, Stethoscope, ScrollText, Building2, LogOut } from 'lucide-react';
...
function Shell() {
  ...
  const titles = { '/': 'Dashboard', '/users': 'User Management', '/clinicians': 'Clinicians', '/audit': 'Audit Log' };

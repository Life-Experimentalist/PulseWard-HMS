...
| GET    | `/integrations/messaging/fault-injection/manifest/verify/attempts/retention` | Show replay-attempt audit retention policy and suppression telemetry for manifest verification history.                  |
| POST   | `/integrations/messaging/fault-injection/manifest/verify/attempts/retention/apply` | Apply replay-attempt retention tuning controls and optional immediate prune for verification audit history.      |

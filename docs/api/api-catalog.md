...
| GET    | `/integrations/messaging/fault-injection/manifest/verify/attempts/retention`       | Show replay-attempt retention policy, saturation alert level, and recommended operator action for verification history.   |
| POST   | `/integrations/messaging/fault-injection/manifest/verify/attempts/retention/apply` | Apply replay-attempt retention tuning controls, optional prune, and return updated saturation diagnostics.                |

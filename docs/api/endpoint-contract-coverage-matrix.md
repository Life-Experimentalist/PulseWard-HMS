...
## M6.117 Anomaly-Tracking-Summary Active-Count Anchor Guardrail Coverage

- Contract checker schema-property assertions now include anomaly-tracking-summary active-count anchors for telemetry payload compatibility.
- Schema property contract checks now enforce:
	- `MessagingFaultManifestVerifyAttemptAnomalyTrackingSummary.activeCount` type `integer`
- Mutation-based parity regressions now prove strict-check failure when anomaly-tracking-summary `activeCount` property type drifts from OpenAPI baseline.

## M6.118 Anomaly-Tracking-Summary Acknowledged-Active-Count Anchor Guardrail Coverage

- Contract checker schema-property assertions now include anomaly-tracking-summary acknowledged-active-count anchors for telemetry payload compatibility.
- Schema property contract checks now enforce:
	- `MessagingFaultManifestVerifyAttemptAnomalyTrackingSummary.acknowledgedActiveCount` type `integer`
- Mutation-based parity regressions now prove strict-check failure when anomaly-tracking-summary `acknowledgedActiveCount` property type drifts from OpenAPI baseline.

## M6.119 Anomaly-Tracking-Summary Unacknowledged-Active-Count Anchor Guardrail Coverage

- Contract checker schema-property assertions now include anomaly-tracking-summary unacknowledged-active-count anchors for telemetry payload compatibility.
- Schema property contract checks now enforce:
...
## M6.144 Recently-Closed-Anomaly Clearance-Evidence AdditionalProperties Guardrail Coverage

- Contract checker schema-property assertions now include recently-closed-anomaly clearance-evidence additional-properties anchors for telemetry payload compatibility.
- Schema property contract checks now enforce:
	- `MessagingFaultManifestVerifyAttemptRecentlyClosedAnomaly.clearanceEvidence` additionalProperties `true`
- Mutation-based parity regressions now prove strict-check failure when recently-closed-anomaly `clearanceEvidence` additionalProperties contract drifts from OpenAPI baseline.

## M6.145 Anomaly-Triage-Note Note-Id Anchor Guardrail Coverage

- Contract checker schema-property assertions now include anomaly-triage-note note-id anchors for telemetry payload compatibility.
- Schema property contract checks now enforce:
	- `MessagingFaultManifestVerifyAttemptAnomalyTriageNote.noteId` type `string`
- Mutation-based parity regressions now prove strict-check failure when anomaly-triage-note `noteId` property type drifts from OpenAPI baseline.

## M6.146 Anomaly-Triage-Note Note-Type Anchor Guardrail Coverage

- Contract checker schema-property assertions now include anomaly-triage-note note-type anchors for telemetry payload compatibility.
- Schema property contract checks now enforce:
	- `MessagingFaultManifestVerifyAttemptAnomalyTriageNote.noteType` type `string`
- Mutation-based parity regressions now prove strict-check failure when anomaly-triage-note `noteType` property type drifts from OpenAPI baseline.

## M6.147 Anomaly-Triage-Note Content Anchor Guardrail Coverage

- Contract checker schema-property assertions now include anomaly-triage-note content anchors for telemetry payload compatibility.
- Schema property contract checks now enforce:
	- `MessagingFaultManifestVerifyAttemptAnomalyTriageNote.content` type `string`
- Mutation-based parity regressions now prove strict-check failure when anomaly-triage-note `content` property type drifts from OpenAPI baseline.

## M6.148 Anomaly-Triage-Note Created-At Anchor Guardrail Coverage

- Contract checker schema-property assertions now include anomaly-triage-note created-at anchors for telemetry payload compatibility.
- Schema property contract checks now enforce:
	- `MessagingFaultManifestVerifyAttemptAnomalyTriageNote.createdAt` type `string`
- Mutation-based parity regressions now prove strict-check failure when anomaly-triage-note `createdAt` property type drifts from OpenAPI baseline.

## M6.149 Anomaly-Triage-Note Author Anchor Guardrail Coverage

- Contract checker schema-property assertions now include anomaly-triage-note author anchors for telemetry payload compatibility.
- Schema property contract checks now enforce:
	- `MessagingFaultManifestVerifyAttemptAnomalyTriageNote.author` type `string`
- Mutation-based parity regressions now prove strict-check failure when anomaly-triage-note `author` property type drifts from OpenAPI baseline.

## M6.150 Anomaly-Triage-Note Mitigation-Applied Anchor Guardrail Coverage

- Contract checker schema-property assertions now include anomaly-triage-note mitigation-applied anchors for telemetry payload compatibility.
- Schema property contract checks now enforce:
	- `MessagingFaultManifestVerifyAttemptAnomalyTriageNote.mitigationApplied` type `boolean`
- Mutation-based parity regressions now prove strict-check failure when anomaly-triage-note `mitigationApplied` property type drifts from OpenAPI baseline.

## M6.151 Anomaly-Triage-Note Mitigation-Type Anchor Guardrail Coverage

- Contract checker schema-property assertions now include anomaly-triage-note mitigation-type anchors for telemetry payload compatibility.
- Schema property contract checks now enforce:
	- `MessagingFaultManifestVerifyAttemptAnomalyTriageNote.mitigationType` type `string`
- Mutation-based parity regressions now prove strict-check failure when anomaly-triage-note `mitigationType` property type drifts from OpenAPI baseline.

## M6.152 Anomaly-Triage-Note Mitigation-Evidence-Ref Anchor Guardrail Coverage

- Contract checker schema-property assertions now include anomaly-triage-note mitigation-evidence-ref anchors for telemetry payload compatibility.
- Schema property contract checks now enforce:
	- `MessagingFaultManifestVerifyAttemptAnomalyTriageNote.mitigationEvidenceRef` type `string`
- Mutation-based parity regressions now prove strict-check failure when anomaly-triage-note `mitigationEvidenceRef` property type drifts from OpenAPI baseline.

## M6.153 Anomaly-Triage-State Acknowledged Anchor Guardrail Coverage

- Contract checker schema-property assertions now include anomaly-triage-state acknowledged anchors for telemetry payload compatibility.
- Schema property contract checks now enforce:
	- `MessagingFaultManifestVerifyAttemptAnomalyTriageState.acknowledged` type `boolean`
- Mutation-based parity regressions now prove strict-check failure when anomaly-triage-state `acknowledged` property type drifts from OpenAPI baseline.

## M6.154 Anomaly-Triage-State Acknowledged-At Anchor Guardrail Coverage

- Contract checker schema-property assertions now include anomaly-triage-state acknowledged-at anchors for telemetry payload compatibility.
- Schema property contract checks now enforce:
	- `MessagingFaultManifestVerifyAttemptAnomalyTriageState.acknowledgedAt` type `string`
- Mutation-based parity regressions now prove strict-check failure when anomaly-triage-state `acknowledgedAt` property type drifts from OpenAPI baseline.

## M6.155 Anomaly-Triage-State Acknowledged-By Anchor Guardrail Coverage

- Contract checker schema-property assertions now include anomaly-triage-state acknowledged-by anchors for telemetry payload compatibility.
- Schema property contract checks now enforce:
	- `MessagingFaultManifestVerifyAttemptAnomalyTriageState.acknowledgedBy` type `string`
- Mutation-based parity regressions now prove strict-check failure when anomaly-triage-state `acknowledgedBy` property type drifts from OpenAPI baseline.

## M6.156 Anomaly-Triage-State Notes-Count Anchor Guardrail Coverage

- Contract checker schema-property assertions now include anomaly-triage-state notes-count anchors for telemetry payload compatibility.
- Schema property contract checks now enforce:
	- `MessagingFaultManifestVerifyAttemptAnomalyTriageState.notesCount` type `integer`
- Mutation-based parity regressions now prove strict-check failure when anomaly-triage-state `notesCount` property type drifts from OpenAPI baseline.

## M6.157 Anomaly-Triage-State Latest-Note Property Guardrail Coverage

- Contract checker schema-property assertions now include anomaly-triage-state latest-note property anchors for telemetry payload compatibility.
- Schema property contract checks now enforce:
	- `MessagingFaultManifestVerifyAttemptAnomalyTriageState.latestNote` property presence
- Mutation-based parity regressions now prove strict-check failure when anomaly-triage-state `latestNote` property is removed from OpenAPI baseline.

## M6.158 Anomaly-Triage-Request Acknowledged-By Anchor Guardrail Coverage

- Contract checker request-schema property assertions now include anomaly-triage-request acknowledged-by anchors for request payload compatibility.
- Request schema property contract checks now enforce:
...
## M6.165 Retention-Saturation-Trend Snapshots Anchor Guardrail Coverage

- Contract checker schema-property assertions now include retention-saturation-trend snapshots anchors for response payload compatibility.
- Schema property contract checks now enforce:
	- `MessagingFaultManifestVerifyAttemptRetentionSaturationTrend.snapshots` type `array`
- Mutation-based parity regressions now prove strict-check failure when retention-saturation-trend `snapshots` property type drifts from OpenAPI baseline.

## M6.166 Retention-Saturation-Trend-Summary Window-Minutes Anchor Guardrail Coverage

- Contract checker schema-property assertions now include retention-saturation-trend-summary window-minutes anchors for response payload compatibility.
- Schema property contract checks now enforce:
	- `MessagingFaultManifestVerifyAttemptRetentionSaturationTrendSummary.windowMinutes` type `integer`
- Mutation-based parity regressions now prove strict-check failure when retention-saturation-trend-summary `windowMinutes` property type drifts from OpenAPI baseline.

## M6.167 Retention-Saturation-Trend-Summary Requested-Limit Anchor Guardrail Coverage

- Contract checker schema-property assertions now include retention-saturation-trend-summary requested-limit anchors for response payload compatibility.
- Schema property contract checks now enforce:
...
## M6.184 Retention-Saturation-Anomaly Key Anchor Guardrail Coverage

- Contract checker schema-property assertions now include retention-saturation-anomaly key anchors for response payload compatibility.
- Schema property contract checks now enforce:
	- `MessagingFaultManifestVerifyAttemptRetentionSaturationAnomaly.key` type `string`
- Mutation-based parity regressions now prove strict-check failure when retention-saturation-anomaly `key` property type drifts from OpenAPI baseline.

## M6.185 Retention-Saturation-Anomaly Severity Anchor Guardrail Coverage

- Contract checker schema-property assertions now include retention-saturation-anomaly severity anchors for response payload compatibility.
- Schema property contract checks now enforce:
	- `MessagingFaultManifestVerifyAttemptRetentionSaturationAnomaly.severity` type `string`
- Mutation-based parity regressions now prove strict-check failure when retention-saturation-anomaly `severity` property type drifts from OpenAPI baseline.

## M6.186 Retention-Saturation-Anomaly Recommended-Action Anchor Guardrail Coverage

- Contract checker schema-property assertions now include retention-saturation-anomaly recommended-action anchors for response payload compatibility.
- Schema property contract checks now enforce:
	- `MessagingFaultManifestVerifyAttemptRetentionSaturationAnomaly.recommendedAction` type `string`
- Mutation-based parity regressions now prove strict-check failure when retention-saturation-anomaly `recommendedAction` property type drifts from OpenAPI baseline.

## M6.187 Retention-Saturation-Anomaly Evidence Anchor Guardrail Coverage

- Contract checker schema-property assertions now include retention-saturation-anomaly evidence anchors for response payload compatibility.
- Schema property contract checks now enforce:
	- `MessagingFaultManifestVerifyAttemptRetentionSaturationAnomaly.evidence` type `object`
- Mutation-based parity regressions now prove strict-check failure when retention-saturation-anomaly `evidence` property type drifts from OpenAPI baseline.

## M6.188 Retention-Saturation-Anomaly Instance-Id Anchor Guardrail Coverage

- Contract checker schema-property assertions now include retention-saturation-anomaly instance-id anchors for response payload compatibility.
- Schema property contract checks now enforce:
	- `MessagingFaultManifestVerifyAttemptRetentionSaturationAnomaly.anomalyInstanceId` type `string`
- Mutation-based parity regressions now prove strict-check failure when retention-saturation-anomaly `anomalyInstanceId` property type drifts from OpenAPI baseline.

## M6.189 Retention-Saturation-Anomaly Status Anchor Guardrail Coverage

- Contract checker schema-property assertions now include retention-saturation-anomaly status anchors for response payload compatibility.
- Schema property contract checks now enforce:
	- `MessagingFaultManifestVerifyAttemptRetentionSaturationAnomaly.status` type `string`
- Mutation-based parity regressions now prove strict-check failure when retention-saturation-anomaly `status` property type drifts from OpenAPI baseline.

## M6.190 Retention-Saturation-Anomaly First-Detected-At Anchor Guardrail Coverage

- Contract checker schema-property assertions now include retention-saturation-anomaly first-detected-at anchors for response payload compatibility.
- Schema property contract checks now enforce:
	- `MessagingFaultManifestVerifyAttemptRetentionSaturationAnomaly.firstDetectedAt` type `string`
- Mutation-based parity regressions now prove strict-check failure when retention-saturation-anomaly `firstDetectedAt` property type drifts from OpenAPI baseline.

## M6.191 Retention-Saturation-Anomaly Last-Detected-At Anchor Guardrail Coverage

- Contract checker schema-property assertions now include retention-saturation-anomaly last-detected-at anchors for response payload compatibility.
- Schema property contract checks now enforce:
	- `MessagingFaultManifestVerifyAttemptRetentionSaturationAnomaly.lastDetectedAt` type `string`
- Mutation-based parity regressions now prove strict-check failure when retention-saturation-anomaly `lastDetectedAt` property type drifts from OpenAPI baseline.

## M6.192 Retention-Saturation-Anomaly Triage Property Guardrail Coverage

- Contract checker schema-property assertions now include retention-saturation-anomaly triage property anchors for response payload compatibility.
- Schema property contract checks now enforce:
	- `MessagingFaultManifestVerifyAttemptRetentionSaturationAnomaly.triage` property presence
- Mutation-based parity regressions now prove strict-check failure when retention-saturation-anomaly `triage` property is removed from OpenAPI baseline.

## M6.193 Retention-Saturation-Anomaly Closed-At Anchor Guardrail Coverage

- Contract checker schema-property assertions now include retention-saturation-anomaly closed-at anchors for response payload compatibility.
- Schema property contract checks now enforce:
...
## M6.204 Anomaly-Escalation-State Pending-Since Anchor Guardrail Coverage

- Contract checker schema-property assertions now include anomaly-escalation-state pending-since anchors for response payload compatibility.
- Schema property contract checks now enforce:
	- `MessagingFaultManifestVerifyAttemptAnomalyEscalationState.pendingSince` type `string`
- Mutation-based parity regressions now prove strict-check failure when anomaly-escalation-state `pendingSince` property type drifts from OpenAPI baseline.

## M6.205 Anomaly-Escalation-State Escalated-At Anchor Guardrail Coverage

- Contract checker schema-property assertions now include anomaly-escalation-state escalated-at anchors for response payload compatibility.
- Schema property contract checks now enforce:
	- `MessagingFaultManifestVerifyAttemptAnomalyEscalationState.escalatedAt` type `string`
- Mutation-based parity regressions now prove strict-check failure when anomaly-escalation-state `escalatedAt` property type drifts from OpenAPI baseline.

## M6.206 Anomaly-Escalation-State Resolved-At Anchor Guardrail Coverage

- Contract checker schema-property assertions now include anomaly-escalation-state resolved-at anchors for response payload compatibility.
- Schema property contract checks now enforce:
	- `MessagingFaultManifestVerifyAttemptAnomalyEscalationState.resolvedAt` type `string`
- Mutation-based parity regressions now prove strict-check failure when anomaly-escalation-state `resolvedAt` property type drifts from OpenAPI baseline.

## M6.207 Anomaly-Escalation-State Due-At Anchor Guardrail Coverage

- Contract checker schema-property assertions now include anomaly-escalation-state due-at anchors for response payload compatibility.
- Schema property contract checks now enforce:
	- `MessagingFaultManifestVerifyAttemptAnomalyEscalationState.dueAt` type `string`
- Mutation-based parity regressions now prove strict-check failure when anomaly-escalation-state `dueAt` property type drifts from OpenAPI baseline.

## M6.208 Anomaly-Escalation-State Action-Required Anchor Guardrail Coverage

- Contract checker schema-property assertions now include anomaly-escalation-state action-required anchors for response payload compatibility.
- Schema property contract checks now enforce:
